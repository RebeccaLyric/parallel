...
** Date: 28 April 2019
** Description: This header file includes the function to evaluate the height 
   at a given iu and iv.
******************************************************************************/
...
// setting the number of trials in the numeric integration simulation:
#ifndef NUMNODES
