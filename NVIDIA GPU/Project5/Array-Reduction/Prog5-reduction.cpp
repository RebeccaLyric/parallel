...
#ifndef GLOBAL_WORK_SIZE
#define GLOBAL_WORK_SIZE 16
#endif

#ifndef NUM_ELEMENTS
#define	NUM_ELEMENTS	SIXTY_FOUR * GLOBAL_WORK_SIZE
#endif
...
const char *		CL_FILE_NAME = { "prog5-reduce.cl" };
...
main( int argc, char *argv[ ] )
{
	...
	// local "prods" array - 1 per work-item
	...
	// sum all results array elements to get final reduction result
	float sum = 0.;
